...
export default Vue.extend({
  ...
  methods: {
    ...
    signalStrengthIcon () {
      ...
      if (this.network.signal >= -67) return 'mdi-wifi-strength-4'
      if (this.network.signal >= -70) return 'mdi-wifi-strength-3'
      if (this.network.signal >= -80) return 'mdi-wifi-strength-2'
