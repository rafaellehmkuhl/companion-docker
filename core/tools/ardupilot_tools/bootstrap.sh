...
## Download and install necessary tools and modules to user binary ans user-site folders, with the correct permissions
...
MODULE_PATH_UPLOADER="${USER_SITE_PACKAGES}/ardupilot_fw_uploader.py"
...
wget "$REMOTE_URL_UPLOADER" -O "$MODULE_PATH_UPLOADER"
