...
from typedefs import Firmware, FirmwareFormat, FlightController, Platform, Vehicle
...
class FirmwareManager:
    ...
    def restore_default_firmware(self, board: FlightController) -> None:
        if not self.is_default_firmware_available(board.platform):
            raise NoDefaultFirmwareAvailable(f"Default firmware not available for platform '{board.name}'.")
